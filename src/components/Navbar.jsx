...
const Navbar = () => {
  ...
  return (
    <div className='absolute w-full flex justify-between p-4'>
        ...
        {nav ? <AiOutlineClose onClick={handleNav} className='z-20 text-white cursor-pointer' size={25} /> : <HiMenuAlt3 onClick={handleNav} className='z-20 text-white cursor-pointer' size={25} />}
        <div className={
            nav 
