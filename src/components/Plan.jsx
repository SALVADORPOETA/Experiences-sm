  ...
  return (
    <div className='max-w-[1400px] m-auto py-16 px-4 grid lg:grid-cols-2 gap-4'>
        ...
        <div className='flex flex-col h-full justify-center'>
            ...
            <p className='text-2xl py-6'>Lorem ipsum dolor sit amet consectetur, adipisicing elit. Aut, error.</p>
            <p className='pb-6'>
                Lorem ipsum dolor sit amet consectetur adipisicing elit. 
                Sapiente saepe inventore fugit rem sint dolores, 
                nihil aperiam voluptatum praesentium dignissimos nobis eius consequatur tempore impedit, 
                laudantium nisi molestias sequi maiores?
            </p>
            <div>
